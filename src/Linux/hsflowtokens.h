...
HSPTOKEN_DATA( HSPTOKEN_PSAMPLEGROUP, "psampleGroup", HSPTOKENTYPE_ATTRIB, "psample { group=[n] }")
HSPTOKEN_DATA( HSPTOKEN_PSAMPLESAMPLERATE, "psampleSampleRate", HSPTOKENTYPE_ATTRIB, "psample { rate=[n] }")
