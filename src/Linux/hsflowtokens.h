...
HSPTOKEN_DATA( HSPTOKEN_EPCAP, "epcap", HSPTOKENTYPE_OBJ, NULL)
HSPTOKEN_DATA( HSPTOKEN_DEV, "dev", HSPTOKENTYPE_ATTRIB, NULL)
HSPTOKEN_DATA( HSPTOKEN_DEV_PATTERN, "dev.pattern", HSPTOKENTYPE_ATTRIB, NULL)
...
HSPTOKEN_DATA( HSPTOKEN_FORCE, "force", HSPTOKENTYPE_ATTRIB, NULL)
...
HSPTOKEN_DATA( HSPTOKEN_MAX_TRIP, "max_trip", HSPTOKENTYPE_ATTRIB, NULL)
...
HSPTOKEN_DATA( HSPTOKEN_OSINDEX, "osIndex", HSPTOKENTYPE_ATTRIB, NULL)
HSPTOKEN_DATA( HSPTOKEN_DYNAMIC, "dynamic", HSPTOKENTYPE_ATTRIB, NULL)
HSPTOKEN_DATA( HSPTOKEN_LINK, "link", HSPTOKENTYPE_ATTRIB, NULL)
HSPTOKEN_DATA( HSPTOKEN_ADDR, "addr", HSPTOKENTYPE_ATTRIB, NULL)
HSPTOKEN_DATA( HSPTOKEN_SETIFALIAS, "setIfAlias", HSPTOKENTYPE_ATTRIB, NULL)
HSPTOKEN_DATA( HSPTOKEN_SETIFNAME, "setIfName", HSPTOKENTYPE_ATTRIB, NULL)
