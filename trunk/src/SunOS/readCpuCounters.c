...
myLog(LOG_INFO, "CPUSTATE_IDLE: %"PRIu32, cpu_info[CPUSTATE_IDLE]);
myLog(LOG_INFO, "CPUSTATE_USER: %"PRIu32, cpu_info[CPUSTATE_USER]);
myLog(LOG_INFO, "CPUSTATE_IOWAIT: %"PRIu32, cpu_info[CPUSTATE_IOWAIT]);
myLog(LOG_INFO, "CPUSTATE_SWAP: %"PRIu32, cpu_info[CPUSTATE_SWAP]);
myLog(LOG_INFO, "CPUSTATE_KERNEL: %"PRIu32, cpu_info[CPUSTATE_KERNEL]);
