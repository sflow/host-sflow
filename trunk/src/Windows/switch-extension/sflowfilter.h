...
/**
 * SFlowExtendedTunnel contains the data associated with an sFlow
 * extended tunnel record.
 */
typedef struct {
    UINT32 vsid;
} SFlowExtendedTunnel, *PSFlowExtendedTunnel;
...
// Extended tunnel
#define EXTENDED_TUNNEL_RECORD_TYPE 1029
